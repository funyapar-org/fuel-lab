...
const ACTIONS = [
  ...
  {
    id: 'injector',
    name: 'エンジンのクリーニング（<a href="{{ site.baseurl }}/knowledge/fuel-additive/">燃料添加剤</a> / プロ清掃）',
    cost_jpy: 3000,
    max_pct: 0.08,
      ...
      <div class="card-body">
        ...
        <div>
          ...
          <ul class="small mb-0">
            ...
            ${it.id === 'injector' ? '<li>洗浄系の<a href="{{ site.baseurl }}/knowledge/fuel-additive/">燃料添加剤</a>を給油時に適量投入、もしくはプロによる洗浄施工を実施。</li>' : ''}
