    ...
    <div class="row g-4">
      ...
      <div class="col-md-6">
        <div class="card h-100 shadow-sm">
          <div class="card-body">
            <h5 class="card-title">
              <a href="{{ site.baseurl }}/knowledge/first-action/" class="text-decoration-none">
      ...
      <div class="col-md-6">
        <div class="card h-100 shadow-sm">
          <div class="card-body">
            <h5 class="card-title">
              <a href="{{ site.baseurl }}/knowledge/air-filter-fuel-economy-na/" class="text-decoration-none">
