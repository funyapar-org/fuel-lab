    ...
    <div class="row g-4">
      ...
      <div class="col-md-6">
        <div class="card h-100 shadow-sm">
          <div class="card-body">
            <h5 class="card-title">
              <a href="/fuel-lab/knowledge/az-ceg-003-0w16-review.html" class="text-decoration-none">
      ...
      <div class="col-md-6">
        <div class="card h-100 shadow-sm">
          <div class="card-body">
            <h5 class="card-title">
              <a href="/fuel-lab/knowledge/engine-oil-viscosity-theory.html" class="text-decoration-none">
                粘度は低いほど燃費に有利？理論的検証
              </a>
            </h5>
            <p class="card-text text-muted small">
